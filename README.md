# WaspLib Setup Instructions

## Option A: Manual Installation

1. Run any WaspLib script at least once (to download Assets)
2. Paste directories `Data` & `Includes` in your root Simba folder and say yes to overwrite. (This will disable auto-updating to allow us to use custom JSONs + This will overwrite current npcs&objects database with the updated coords)
